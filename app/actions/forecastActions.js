...
export const fetchForecast = (searchText) => {
  ...
  function request() {
    return { type: forecastConstants.FETCH_FORECAST_REQUEST };
  }
  function success(forecasts) {
    return {
      type: forecastConstants.FETCH_FORECAST_SUCCESS,
      payload: forecasts,
    };
  }
  function failure(error) {
    return { type: forecastConstants.FETCH_FORECAST_FAILURE, payload: error };
  }
};
